...
class MyMapPage extends StatefulWidget {
  ...
  @override
  _MyMapPageState createState() => _MyMapPageState(task);
}

TaskDetail taskDetails= new TaskDetail("03", "Test Task", "Sample data", 24.92882971812439, 67.0578712459639);
...
class _MyMapPageState extends State<MyMapPage>  {
  ...
  String googleAPiKey = 'AIzaSyB3Ivj-68o2YYHdlFcHTvqrhurQUPrj5AY';
                  ...
                  children: <Widget>[
                     ListTile(
                      ...
                      subtitle: Text(taskDetails.taskNote),
                        ...
                        children: <Widget>[
                          RaisedButton(
                            onPressed: isEnabled ? ()=> {getCurrentLocation() }: null,
                            color: myHexColor,
                  ...
                  children: <Widget>[
                    IconButton(
                        ...
                        icon: Transform.scale(
                          scale: 1,child :new Image.asset('assets/gkg_app_icon_search.png'),),
                        onPressed: () {
                          _launchURL();
                        }
                    ),
                    IconButton(
                        ...
                        icon: Transform.scale(
                          scale: 1,child :new Image.asset('assets/gkg_app_icon_back.png'),),
                        onPressed: () {
                    ...
                    IconButton(
                        ...
                        padding: EdgeInsets.fromLTRB(10,25, 10, 25),
                        icon: Transform.scale(
                          scale: 1,child :new Image.asset('assets/gkg_app_icon_home.png'),),
                        onPressed: ()  async {
                    ...
                    IconButton(
                        ...
                        icon: Transform.scale(
                            scale: 1,child :new Image.asset('assets/gkg_app_icon_call.png')),
                        onPressed: () {
